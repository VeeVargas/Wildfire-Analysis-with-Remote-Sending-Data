#creates a dataset from images in "aus_fire_bucket_good"  
...
def rotate_flip_batch(x, noise_factor=0):
    """
    apply random transforms: rotate and flips examples in given batch
...
def print_statistics(curr_l, curr_preds, curr_y):
    ...
    try:
        ...
        f1 = 0
    print("Eval: Loss:{:.3f}, fire:{}/{}, no fire:{}/{}, accur:{:.3f}, Mean accuracy:{:.3f}".format(curr_l,
                                                                                        tp, tp+fn, tn, fp+tn,
                                                                                        (tp+tn)/(tp+tn+fp+fn),
